<template>
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
      ...
      <NuxtLink class="navbar-brand m-0" :to="{name: 'dashboard'}">
        <img src="/icon.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold text-uppercase">SDP {{ $nuxt.$route.name }}</span>
      </NuxtLink>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <NuxtLink class="nav-link" :to="{name: 'dashboard'}">
            <div
        ...
        <li class="nav-item">
          <NuxtLink class="nav-link" :to="{name: 'query'}">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 45 40" xmlns="http://www.w3.org/2000/svg"
                   xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="nav-link-text ms-1">New Query</span>
          </NuxtLink>
        </li>
        <li class="nav-item">
          <NuxtLink class="nav-link" :to="{name: 'user'}">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <NuxtLink class="nav-link" :to="{name: 'ads'}">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
                   xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <li class="nav-item">
          <NuxtLink class="nav-link" :to="{name: 'parts'}">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Parts</span>
          </NuxtLink>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Control</h6>
        </li>
        <li class="nav-item">
          <NuxtLink class="nav-link" :to="{name: 'add-user'}">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="14px" height="14px" xmlns="http://www.w3.org/2000/svg" class="w-100"
                   viewBox="0 0 512 512" xml:space="preserve">
                <g>
                    <path class="color-background" d="M352.062,314.075c-19.834-20.912-43.665-36.124-68.765-44.408c25.008-22.555,40.754-55.191,40.754-91.439
                ...
                <g>
                    <polygon class="color-background" points="453.671,223.595 453.671,165.266 414.785,165.266 414.785,223.595 356.456,223.595 356.456,262.481
        ...
        <li class="nav-item">
          <NuxtLink class="nav-link" :to="{name: 'add-machine'}">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="14px" height="14px" xmlns="http://www.w3.org/2000/svg" class="w-100"
                   viewBox="0 0 512 512" xml:space="preserve">
            ...
            <span class="nav-link-text ms-1">Add Machine</span>
          </NuxtLink>
        </li>
      </ul>
      <div class="d-flex justify-content-center mt-5 d-lg-none d-md-flex d-none">
        <button class="btn btn-behance text-center w-75" onclick="toggleSidenav()">Close</button>
      </div>
    </div>
  </aside>
</template>
