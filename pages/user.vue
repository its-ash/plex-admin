            ...
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0">
                ...
                <tr>
                  ...
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Machine
                  </th>
                </tr>
                </thead>
                <tbody>
                <tr class="machine-list" @click="$store.dispatch('showMachineListBox')">
                  <td>
